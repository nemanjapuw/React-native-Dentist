...
class LabDentalNewService1 extends Component {
    ...
    componentDidMount() {
        ...
        //get item
        if (!Utils.isEmpty(this.props.navigation.state.params.item3)) {           
            let item3 = this.props.navigation.state.params.item3;
    ...
    completeBtn() {
        ...
        this.props.navigation.navigate('LabDentalNewService', { file3: file, item3: item, randomNumber: this.randomNumber });
    }
                    ...
                    <ImageBackground source={Images.signin_back} style={styles.signup_back}>
                        <View style={styles.topview}>
                            ...
                            <Text style={styles.main_text}>
                                {Utils.translate("Ldentalnewservcie3.label")}
                            </Text>
                        </View>
                                ...
                                <ScrollView>
                                    ...
                                    <View>
                                        <Text style={[styles.title, { textAlign: 'center' }]}>
                                            {Utils.translate("Ldentalnewservcie3.title1")}
                                        </Text>
                                        <Text style={styles.second_title}>
                                            {Utils.translate("Ldentalnewservcie3.desc1")}
                                        </Text>
                                    </View>
                                    ...
                                    <View style={{ paddingTop: 25 }}>
                                        <Text style={[styles.title, { textAlign: 'center' }]}>
                                            {Utils.translate("Ldentalnewservcie3.title2")}
                                        </Text>
                                        <Text style={styles.second_title}>
                                            {Utils.translate("Ldentalnewservcie3.desc2")}
                                        </Text>
                                    </View>
                                    <View style={{ backgroundColor: 'white', borderRadius: 15, height: 120, width: "100%", marginTop: 5 }}>
                                        <FlatList
                                    ...
                                    <View style={{ paddingTop: 25 }}>
                                        <Text style={[styles.title, { textAlign: 'center' }]}>
                                            {Utils.translate("Ldentalnewservcie3.title3")}
                                        </Text>
                                        <Text style={styles.second_title}>
                                            {Utils.translate("Ldentalnewservcie3.desc3")}
                                        </Text>
                                    </View>
                                    <View style={{ backgroundColor: 'white', borderRadius: 15, height: 120, width: "100%", marginTop: 5 }}>
                                        <FlatList
                                    ...
                                    <View style={{
                                        ...
                                        <View style={{ width: "100%" }}>
                                            ...
                                            >
                                                {Utils.translate("Ldentalnewservcie3.continue")}
                                            </Button>
                                        </View>
                                        <View style={{ flexDirection: "row", textAlign: "center", alignItems: "center", marginTop: 10 }}>
                                            ...
                                            <Text style={styles.signup_labelSecond}>
                                                {Utils.translate("Ldentalnewservcie3.page2")}
                                            </Text>
                                        </View>
                                    </View>
                                </ScrollView>
